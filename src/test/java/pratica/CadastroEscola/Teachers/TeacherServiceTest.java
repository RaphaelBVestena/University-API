...
class TeacherServiceTest {
    ...
    void setUp() {
        ...
        Page<TeacherModel> teacherPage = new PageImpl<>(TeacherCreator.createValidTeacherList(numberOfElements));

        BDDMockito.when(teacherRepository.findAll())
                .thenReturn(TeacherCreator.createValidTeacherList(numberOfElements));
    ...
    void getAllPaged_ReturnsListOfTeacherResponseDTOsInsidePage_WhenSuccessful() {
        ...
        Page<TeacherResponseDTO> serviceResponse = teacherService.getAllPaged(PageRequest.of(1, 1));
    ...
    void getAll_ReturnsListOfTeacherResponseDTOs_WhenSuccessful() {
        ...
        List<TeacherResponseDTO> serviceResponse = teacherService.getAll();
    ...
    void getById_ReturnsTeacherResponseDTO_WhenSuccessful() {
        ...
        TeacherResponseDTO serviceResponse = teacherService.getById(UUID.randomUUID());

        Assertions.assertThat(serviceResponse).isNotNull();

        Assertions.assertThat(serviceResponse.getName()).isEqualTo(expectedTeacher.getName());
        Assertions.assertThat(serviceResponse.getEmail()).isEqualTo(expectedTeacher.getEmail());
        Assertions.assertThat(serviceResponse.getPhone()).isEqualTo(expectedTeacher.getPhone());
        Assertions.assertThat(serviceResponse.getGender()).isEqualTo(expectedTeacher.getGender());
        Assertions.assertThat(serviceResponse.getBirthDate()).isEqualTo(expectedTeacher.getBirthDate());
    ...
    void post_ReturnsTeacherResponseDTO_WhenSuccessful() {
        ...
        TeacherResponseDTO serviceResponse = teacherService.post(TeacherCreator.createTeacherRequestDTO());
    ...
    void patch_ReturnsTeacherResponseDTO_WhenSuccessful() {
        ...
        TeacherResponseDTO serviceResponse = teacherService.patchById(UUID.randomUUID(),
